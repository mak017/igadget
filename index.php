...
<body class="green-theme" data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<noscript>
		<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1195543740514431&ev=PageView&noscript=1"
		/>
	</noscript>
	<!-- End Facebook Pixel Code -->
	...
	<noscript>
		<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=473117753069915&ev=PageView&noscript=1"
		/>
	</noscript>
	<!-- End Facebook Pixel Code -->
	...
	<noscript>
		<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=534326753582146&ev=PageView&noscript=1"
		/>
	</noscript>
	<!-- End Facebook Pixel Code -->
	...
	<noscript>
		<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=906247872866691&ev=PageView&noscript=1"
		/>
	</noscript>
	<!-- End Facebook Pixel Code -->
	...
	<noscript>
		<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=403255396756614&ev=PageView&noscript=1"
		/>
	</noscript>
	<!-- End Facebook Pixel Code -->
	...
	<nav class="navbar navbar-solomon">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand navbar-brand-solomon" href="#">
					<span class="span-brand-solomon">I</span>Gadget</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-solomon-li">
					<li>
						<a href="#section1">Видеообзор</a>
					</li>
					<li>
						<a href="#section2">Преимущества</a>
					</li>
					<li>
						<a href="#section3">Модели</a>
					</li>
					<li>
						<a href="#section4">Совместимость</a>
					</li>
					<li>
						<a href="#section5">Как заказать</a>
					</li>
					<li>
						<button type="button" class="btn122" data-toggle="modal" data-target="#myModal70">СВЯЗАТЬСЯ С НАМИ</button>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="container grey main-logo-margin">
		<div class="row">
			<div class="item main col-sm-4">
				...
				<p>Диск
					<span>быстрой</span> беспроводной
					<span>зарядки</span>
				</p>
				<div class="price">
			...
			<div class="item auto col-sm-4 border-mobile">
				...
				<p>
					<span>Автомобильная</span> беспроводная
					<span>зарядка</span>
				</p>
				<div class="price">
					<div class="regular-price"></div>
						...
						<div class="modal-body">
							<form method="POST" action="send_mail.php">
								...
								<div class="form-group" style="margin-top: 15px">
									<input style="background: #f8f8f8;" type="text" name="name" placeholder="Имя..." class="form-control input-lg" id="form-username4"
									  required="required">
								</div>
								<div class="form-group" style="margin-bottom: 15px">
									<input style="background: #f8f8f8;" type="phone" name="phone" placeholder="Номер телефона..." class="form-control input-lg"
									  id="form-phone4" required="required">
								</div>
			...
			<div class="col-lg-3 col-sm-4 text-center visa-margin-bottom">
				<span class="text-center">бесплатная доставка при оплате</span>
				<img class="visa-mastercard" src="phones/visa-mastercard1.png">
	...
	<div class="grey problems">
		...
		<p class="dark-grey text-above-setka text-center">Заряжать Ваши гаджеты, будет комфортнее без проводов.
			<br>
	...
	<div class="container chargers" id="chargers">
		<div class="row">
			...
			<div class="big-margin">
				<p class="jumbo">АКЦИЯ!
					<span style="font-family: 'Solomon Sans Normal'; color: #ff0000">Скидка до -35%</span> на обе модели!</p>
			</div>

			<!-- SLIDER 1 -->
			<div class="col-sm-6 text-center slider-with-border">
				<p class="text-center solomon-light product-title">Беспроводное зарядное устройство
					<br>
					<span style="font-family: 'Solomon Sans SemiBold'; font-size: 18px">LUNA STANDART</span>
				</p>
							...
							<div class="carousel slide" id="myCarousel233">
								<div class="carousel-inner">
									<div class="active item" data-slide-number="0">
										<img src="phones/slider_standart_1.jpg">
									</div>
									<div class="item" data-slide-number="1">
										<img src="phones/slider_standart_2.jpg">
									</div>
									<div class="item" data-slide-number="2">
										<img src="phones/slider_standart_3.jpg">
									</div>
									<div class="item" data-slide-number="3">
										<img src="phones/slider_standart_4.jpg">
									</div>
								</div>
								<!-- Carousel nav -->
								<a class="left carousel-control" href="#myCarousel233" role="button" data-slide="prev">
									<span class="glyphicon glyphicon-chevron-left"></span>
								</a>
								<a class="right carousel-control" href="#myCarousel233" role="button" data-slide="next">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body" style="padding: 25px; text-align: left; font-size: 15px">
								<p>
									<b>Время подзарядки батареи смартфона от 0 до 100%:</b> 1,5-2 ч в зависимости от объема батареи вашего телефона.</p>
								<br>
								<p>
								...
								<br>
								<p>
									<b>Напряжение:</b> DC 5V 2A / DV 5V 1.5A</p>
								<p>
									<b>Размеры зарядного устройства:</b> 100*100*9.5 мм</p>
								<p>
									<b>Вес зарядного устройства:</b> 74 г</p>
							</div>
			...
			<div class="col-sm-6 text-center">
				<p class="text-center solomon-light product-title">Беспроводное зарядное устройство
					<br>
					<span style="font-family: 'Solomon Sans SemiBold'; font-size: 18px">быстрой зарядки
						<br>LUNA FANTASY</span>
				</p>
					...
					<div class="row">
						<div id="carousel-bounding-box2">
							<div class="carousel slide" id="myCarousel299">
								<div class="carousel-inner">
									<div class="active item" data-slide-number="0">
										<img src="phones/slider_fantasy_31.jpg">
									</div>
									<div class="item" data-slide-number="1">
										<img src="phones/slider_fantasy_21.jpg">
									</div>
									<div class="item" data-slide-number="2">
										<img src="phones/slider_fantasy_5.jpg">
									</div>
									<div class="item" data-slide-number="3">
										<img src="phones/slider_fantasy_4.jpg">
									</div>
								</div>
								<!-- Carousel nav 2 -->
								<a class="left carousel-control" href="#myCarousel299" role="button" data-slide="prev">
									<span class="glyphicon glyphicon-chevron-left"></span>
								</a>
								<a class="right carousel-control" href="#myCarousel299" role="button" data-slide="next">
									<span class="glyphicon glyphicon-chevron-right"></span>
								</a>
								<!-- Carousel nav 2 END-->
							</div>
				...
				<ul class="hide-bullets">
					...
					<li class="col-xs-3">
						<a class="thumbnail" id="carousel-selector2-2">
							<img src="phones/slider_fantasy_5.jpg">
						</a>
					</li>
					<li class="col-xs-3">
						<a class="thumbnail" id="carousel-selector2-3">
							<img src="phones/slider_fantasy_4.jpg">
						</a>
					</li>
				</ul>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body" style="padding: 25px; text-align: left; font-size: 14px">
								<p>
									<u>Имеет функцию
										<span style="font-family: 'Solomon Sans SemiBold'">FAST CHARGE!!!</span>
									</u>
								</p>
								<br>
								<p>
									<b>Время подзарядки батареи смартфона от 0 до 100%:</b>
									<br> 1,5-2 ч в зависимости от объема батареи вашего телефона.</p>
								<br>
								<p>
									<b>В комплект входит:</b>
								</p>
								...
								<p>
									<b>Напряжение:</b> DC 5V 2A / DV 5V 1.5A</p>
								<p>
									<b>Размеры зарядного устройства:</b> 76*76*6 мм</p>
								<p>
									<b>Вес зарядного устройства:</b> 60 г</p>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-default btn-success" data-dismiss="modal">Закрыть</button>
							</div>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="send_mail.php">
									...
									<div class="form-group" style="margin-top: 15px">
										<input style="background: #f8f8f8;" type="text" name="name" placeholder="Имя..." class="form-control input-lg" id="form-username"
										  required="required">
									</div>
									<div class="form-group" style="margin-bottom: 15px">
										<input style="background: #f8f8f8;" type="phone" name="phone" placeholder="Номер телефона..." class="form-control input-lg"
		...
		<div class="row">
			<div class="col-sm-12 margin-bottom-setka">
				<div class="col-sm-4">
					...
					<p class="text-above-photo">Вставьте в разъем
						<br>устройства ресивер</p>
				</div>
				<div class="col-sm-4">
					...
					<p class="text-above-photo">Спрячьте ресивер
						<br>под чехол</p>
				</div>
				<div class="col-sm-4">
					...
					<p class="text-above-photo">Положите телефон
						<br>на зарядку</p>
				</div>
			</div>
		</div>
	...
	<div class="grey additional">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-5">
					<p id="text-above-powerbank" class="solomon-light text-center big-margin product-title">Беспроводной повербанк
						<br>
						<span class="text-below-powerbank">LUNA</span>
					</p>
					...
					<div class="carousel slide" data-ride="carousel" id="quote-carousel2">
						...
						<a data-slide="prev" href="#quote-carousel2" class="left carousel-control">
							<i class="fa fa-chevron-left"></i>
						</a>
						<a data-slide="next" href="#quote-carousel2" class="right carousel-control">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body" style="padding: 25px; text-align: left; font-size: 15px">
										...
										<p>Продукт имеет встроенный передатчик беспроводного электричества Qi стандарта и два USB порта для заряда устройств
											с помощью шнура</p>
										<ul>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal">&times;</button>
									<p class="modal-title text-center" style="font-size: 25px">Сделать заказ</p>
									<p class="text-center" style="margin-top: 12px; margin-bottom: -2px">Мы свяжемся с Вами в течении часа и
										<b>
											<u>уточним модель повербанка</u>
										</b>
									</p>
								</div>
								<div class="modal-body">
									<form method="POST" action="send_mail.php">
										...
										<div class="form-group" style="margin-top: 15px">
											<input style="background: #f8f8f8;" type="text" name="name" placeholder="Имя..." class="form-control input-lg" id="form-username12"
											  required="required">
											<!--                                        <input type="hidden" id="form-product4" value="3 POWERBANKS">-->
										</div>
										<div class="form-group" style="margin-bottom: 15px">
											<input style="background: #f8f8f8;" type="phone" name="phone" placeholder="Номер телефона..." class="form-control input-lg"
											  id="form-phone12" required="required">
										</div>
	...
	<div class="container together">
		<div class="row">
			<div class="col-xs-12 text-center">
				<p id="setka3" class="jumbo">Вместе
					<span style="font-family: 'Solomon Sans Normal'; color: #ff0000">дешевле</span>
				</p>
			</div>
			<div class="col-sm-6 slider-with-border">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="send_mail.php">
									...
									<div class="form-group" style="margin-top: 15px">
										<input style="background: #f8f8f8;" type="text" name="name" placeholder="Имя..." class="form-control input-lg" id="form-username13"
										  required="required">

									</div>
									<div class="form-group" style="margin-bottom: 15px">
										<input style="background: #f8f8f8;" type="phone" name="phone" placeholder="Номер телефона..." class="form-control input-lg"
										  id="form-phone13" required="required">
									</div>
				...
				<p class="below-button solomon-light text-center">Экономия
					<span style="font-family: 'Solomon Sans SemiBold'">300 грн</span>
				</p>
			</div>
			<div class="col-sm-6">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="send_mail.php">
									...
									<div class="form-group" style="margin-top: 15px">
										<input style="background: #f8f8f8;" type="text" name="name" placeholder="Имя..." class="form-control input-lg" id="form-username14"
										  required="required">
										<!-- <input type="hidden" id="form-product6" value="LUNA FANTASY and POWERBANK"> -->
									</div>
									<div class="form-group" style="margin-bottom: 15px">
										<input style="background: #f8f8f8;" type="phone" name="phone" placeholder="Номер телефона..." class="form-control input-lg"
										  id="form-phone14" required="required">
									</div>
				...
				<p class="below-button solomon-light text-center">Экономия
					<span style="font-family: 'Solomon Sans SemiBold'">200 грн</span>
				</p>
			</div>
		</div>
	</div>
	...
	<div class="col-sm-12 grey additional autocharger">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-5">
					<p id="text-above-powerbank" class="solomon-light text-center big-margin product-title">Автомобильное зарядное устройство
						<br>
						<span class="text-below-powerbank">LUNA</span>
					</p>
					...
					<div class="carousel slide" data-ride="carousel" id="quote-carousel3">
						...
						<!-- Carousel Buttons Next/Prev -->
						<a data-slide="prev" href="#quote-carousel3" class="left carousel-control">
							<i class="fa fa-chevron-left"></i>
						</a>
						<a data-slide="next" href="#quote-carousel3" class="right carousel-control">
							<i class="fa fa-chevron-right"></i>
						</a>
					</div>
						...
						<div id="myModal265" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body" style="padding: 25px; text-align: left; font-size: 15px">
										<p>Продукт имеет:
											<br> - встроенный передатчик беспроводного электричества Qi стандарта.
											<br> - два вида крепления: один - в дефлектор воздуховода автомобиля. Второй, на липкой основе, к любому месту на
											торпеде или лобовом стекле Вашего авто.
											<br> Вы можете снять зарядное устройство с крепления в любой момент, когда зарядка Вам не нужна.</p>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<p class="text-center" style="margin-top: 12px; margin-bottom: -2px">Мы свяжемся с Вами в течении часа и
										<b>
											<u>уточним модель автомобильного зарядного устройства</u>
										</b>
									</p>
								</div>
								<div class="modal-body">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="send_mail.php">
									...
									<div class="form-group" style="margin-top: 15px">
										<input style="background: #f8f8f8;" type="text" name="name" placeholder="Имя..." class="form-control input-lg" id="form-username15"
										  required="required">

									</div>
									<div class="form-group" style="margin-bottom: 15px">
										<input style="background: #f8f8f8;" type="phone" name="phone" placeholder="Номер телефона..." class="form-control input-lg"
										  id="form-phone15" required="required">
									</div>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="send_mail.php">
									...
									<div class="form-group" style="margin-top: 15px">
										<input style="background: #f8f8f8;" type="text" name="name" placeholder="Имя..." class="form-control input-lg" id="form-username16"
										  required="required">
									</div>
									<div class="form-group" style="margin-bottom: 15px">
										<input style="background: #f8f8f8;" type="phone" name="phone" placeholder="Номер телефона..." class="form-control input-lg"
										  id="form-phone16" required="required">
									</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 text-center">
				<p id="setka3" class="jumbo">
					<span style="font-family: 'Solomon Sans Normal'; color: #ff0000">Эксклюзивное предложение</span>
				</p>
			</div>
			<div class="col-sm-6 slider-with-border">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="send_mail.php">
									...
									<div class="form-group" style="margin-top: 15px">
										<input style="background: #f8f8f8;" type="text" name="name" placeholder="Имя..." class="form-control input-lg" id="form-username17"
										  required="required">
									</div>
									<div class="form-group" style="margin-bottom: 15px">
										<input style="background: #f8f8f8;" type="phone" name="phone" placeholder="Номер телефона..." class="form-control input-lg"
										  id="form-phone17" required="required">
									</div>
				...
				<p class="below-button solomon-light text-center">Экономия
					<span style="font-family: 'Solomon Sans SemiBold'">450 грн</span>
				</p>
			</div>
			<div class="col-sm-6">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST" action="send_mail.php">
									...
									<div class="form-group" style="margin-top: 15px">
										<input style="background: #f8f8f8;" type="text" name="name" placeholder="Имя..." class="form-control input-lg" id="form-username18"
										  required="required">
										<!-- <input type="hidden" id="form-product6" value="LUNA FANTASY and POWERBANK"> -->
									</div>
									<div class="form-group" style="margin-bottom: 15px">
										<input style="background: #f8f8f8;" type="phone" name="phone" placeholder="Номер телефона..." class="form-control input-lg"
										  id="form-phone18" required="required">
									</div>
									<button type="submit" id="send14" class="btn777" style="margin-bottom: 15px">КУПИТЬ СО СКИДКОЙ</button>
								</form>
							</div>
				...
				<p class="below-button solomon-light text-center">Экономия
					<span style="font-family: 'Solomon Sans SemiBold'">500 грн</span>
				</p>
			</div>
		</div>
	</div>
	...
	<div class="grey four-types">
		<div class="container">
			<div class="row">
				<div id="section4"></div>
				<div class="col-xs-12">
					<p id="setka4" class="jumbo">Максимальная совместимость
						<br>со всеми видами Ваших гаджетов</p>
				</div>
				...
				<div class="col-sm-12">
					<div class="col-sm-6 setka-with-margin">
						...
						<div class="col-sm-8 text-center four-types-text-colomn">
							...
							<p class="solomon-light p-below-four-type-item">Lightning порт совместим с
								<br>iPhone 5/5s/6/6s/6 Plus/6s Plus/7/7 Plus</p>
					...
					<div class="col-sm-6 setka-with-margin">
						...
						<div class="col-sm-8 text-center four-types-text-colomn">
							...
							<p class="solomon-light p-below-four-type-item">USB-порт у большинства смартфонов
								<br>и телефонов Samsung, LG, Sony, Nexus</p>
				...
				<div class="col-sm-12">
					<div class="col-sm-6 setka-with-margin">
						...
						<div class="col-sm-8 text-center four-types-text-colomn">
							...
							<p class="solomon-light p-below-four-type-item">Встречается довольно редко,
								<br>например, у Meizu</p>
					...
					<div class="col-sm-6 setka-with-margin">
						...
						<div class="col-sm-8 text-center four-types-text-colomn">
							...
							<p class="solomon-light p-below-four-type-item">Новый стандарт двухстороннего
								<br>USB-порта для Android</p>
							<a class="btn9090 solomon-light" data-toggle="modal" data-target="#myModal2">Подробнее</a>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-12 text-center garanty-div">
					<div class="col-sm-4 garanty-text-side">
						...
						<p class="solomon-light p-below-garanty-text">Гарантия на товар
							<br>
							<span style="font-family: 'Solomon Sans Normal'">12 МЕСЯЦЕВ</span</p>
					</div>
					<div class="col-sm-4">
					...
					<div class="col-sm-4 garanty-text-side">
						...
						<p class="solomon-light p-below-garanty-text">Гарантия возврата
							<br>
							<span style="font-family: 'Solomon Sans Normal'">14 ДНЕЙ</span</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="col-sm-6 padding-150 slider-with-border-black">
						<span class="dostavka_name">ПО КИЕВУ</span>
						<img src="phones/kyiv_herb.png">
						<p class="p-below-dostavka-name solomon-light">Курьером
							<br>по Киеву</p>
					...
					<div class="col-sm-6 padding-150">
						<span class="dostavka_name">ПО УКРАИНЕ</span>
						<img id="nova-poshta" src="phones/nova_poshta.png">
						<p class="p-below-dostavka-name solomon-light">Доставка Новой почтой
							<br>по всей Украине</p>
							...
							<blockquote>
								<div class="row">
									...
									<div class="col-sm-9 otzyv">
										<p>Заказал одну. По поводу самой зарядки - полностью доволен. Заряжает хорошо и довольно быстро. Работает через бампер
											на телефоне без проблем.</p>
										<small>Роман</small>
									</div>
								</div>
							</blockquote>
						...
						<div class="item">
							<blockquote>
								<div class="row">
									...
									<div class="col-sm-9 otzyv">
										<p>Пользуюсь неделю, изменил свою точку зрения. Очень удобная вещь! Использование рессивера не так критично, как это
											показалось в первый день.</p>
										<small>Михаил</small>
									</div>
								</div>
							</blockquote>
							...
							<blockquote>
								<div class="row">
									...
									<div class="col-sm-9 otzyv">
										...
										<span>
											<b>Достоинства:</b> Удобно и быстро.</span>
										<small>Антон</small>
									</div>
								</div>
							</blockquote>
	...
	<div class="grey answers">
		<div class="container">
			<div class="row">
				...
				<div class="acc">
					<p class="acc_top">Мы предоставляем, на весь ассортимент товаров в наших магазинах, гарантию до 1 года. Гарантия начинает действовать с
						момента как Вы получили товар. Расходы по доставке в процессе обмена товара с дефектом мы берём на себя! Мы работаем
						строго в соответствии с Украинским законодательством и всегда идем на встречу нашим клиентам!</p>
					<p class="acc_top">
						<b>Если в процессе использования, Вы обнаружили дефект, или товар стал некорректно функционировать:</b>
					</p>
					<ol>
					...
					<p class="acc_top">
						<b>Если товар Вам просто не понравился, то в течение 14 дней Вы можете вернуть его нам, без объяснения причин:</b>
					</p>
					<ol>
				...
				<div class="acc">
					<p class="acc_top">Если у вас остались вопросы позвоните по бесплатному номеру: +38 (067) 448-88-55 или оставьте заявку, мы сами позвоним
						и проконсультируем.</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<p id="voprosy" class="jumbo">У Вас остались вопросы?
					<br>Задайте их нам</p>
			</div>
			<div class="col-sm-6 col-sm-offset-3">
				<form method="POST" action="send_mail.php">
					...
					<div class="form-group">
						<label for="phone">
							<span style="font-size: 18px">Телефон</span>
						</label>
					...
					<div class="form-group">
						<label for="comment">
							<span style="font-size: 18px">Введите вопрос</span>
						</label>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4" style="margin: 50px 0 0 0">
					...
					<br>
					<span class="padding-podval">
						<button type="button" class="btn122 inverse" data-toggle="modal" data-target="#myModal70">СВЯЗАТЬСЯ С НАМИ</button>
					</span>
				...
				<div class="col-md-4" style="margin: 50px 0 0 0">
					...
					<iframe style="border: 1px solid rgba(14, 9, 9, 0.45); border: none; overflow: hidden; box-shadow: -3px 9px 70px 1px rgba(0, 0, 0, 0.66)"
					  ...
					  width="305" height="214" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
					<br>
					<p style="margin-top: 100px; color: #333">
						<a href="opt/index.html" style="color: #333">Оптовым покупателям</a>
					</p>
				</div>
			</div>
		</div>
	...
	<div id="scrollup">
		<img alt="Прокрутить вверх" src="phones/scroll_up.png" width="60%">
	</div>
