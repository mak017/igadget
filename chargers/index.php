...
<head>
	...
	<script>
		...
		})(window, document, 'script', 'dataLayer', 'GTM-PWTD3HZ');
	</script>
	...
	<noscript>
		<div><img src="https://mc.yandex.ru/watch/45852324" style="position:absolute; left:-9999px;" alt="" /></div>
	</noscript>
	<!-- /Yandex.Metrika counter -->
<!-- Facebook Pixel Code -->
<script>
...
'https://connect.facebook.net/en_US/fbevents.js');
 fbq('init', '217096718678071'); 
fbq('track', 'PageView');
</script>
<noscript>
 <img height="1" width="1" 
src="https://www.facebook.com/tr?id=217096718678071&ev=PageView
&noscript=1"/>
</noscript>
<!-- End Facebook Pixel Code -->
</head>

<body class="red-theme" data-spy="scroll" data-target=".navbar" data-offset="50">
		...
		<div class="container main-logo-margin">
			<div class="row">
				<div class="item main col-sm-4">
					<img class="phone-main-banner" src="/phones/red.png">
				...
				<!-- <div class="item power col-sm-4">
					<img class="img-responsive" src="/phones/powerbank-black.png">
					<p>Беспроводной <span>повербанк</span></p>
				</div>
				<div class="item auto col-sm-4 border-mobile">
					<img class="img-responsive" src="/phones/auto_charge-black.png">
	...
	<div class="background-black problems">
		<div id="section2"></div>
		...
		<p class="text-above-setka text-center block-divider">Заряжать Ваши гаджеты, будет комфортнее без проводов.<br>
	...
	<div class="container chargers" id="chargers">
		<div class="row">
			...
			<div class="big-margin">
				<p class="jumbo">АКЦИЯ! <span style="font-family: 'Solomon Sans Normal'; color: #f00">Скидка до -35%</span> на обе модели!</p>
			</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body" style="padding: 25px; text-align: left; font-size: 14px">
								<p>
									<u>Имеет функцию <span style="font-family: 'Solomon Sans SemiBold'">FAST CHARGE!!!</span></u>
								</p><br>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 margin-bottom-setka">
					<p class="text-above-setka text-center solomon-light block-divider">Простой способ установки.</p>
					<div class="col-sm-4">
	...
	<div class="background-black four-types">
		<div class="container">
			<div class="row">
				<div id="section4"></div>
				<div class="col-xs-12">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<img id="zakaz" class="img-responsive" src="/phones/Delivery2-min.png">
			</div>
		</div>
	</div>

	<div id="dostavka" class="background-black">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
				...
				<div class="col-sm-12">
					<div class="col-sm-6 padding-150 slider-with-border-orange">
			...
			<div class="row">
				<div class="col-md-4" style="margin: 50px 0 0 0">
					...
					<ul style="list-style: none">
						...
						<li><i class="glyphicon glyphicon-map-marker" style="margin-right: 15px; padding: 0.5em 0"> </i>г. Киев, ул. Стройиндустрии
							8-б</li>
				...
				<div class="col-md-4" style="margin: 50px 0 0 0">
					...
					<iframe style="border: 1px solid rgba(14, 9, 9, 0.45); border: none; overflow: hidden; box-shadow: -3px 9px 70px 1px rgba(0, 0, 0, 0.66)"
					  ...
					  width="305" height="214" scrolling="no" frameborder="0" allowTransparency="true"></iframe><br>
	...
	<div class="slidebox chargers" id="slidebox">
		...
		<p>Вы можете получить второй приёмник/ресивер в подарок Чтобы получить ПОДАРОК, закажите его у оператора. Назовите оператору
			КОД ПОДАРКА: 0711
		</p>
	</div>
